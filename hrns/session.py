...
DeepSeek's context cache is keyed on the *prefix* of the request. A cache hit
happens when the leading bytes of `messages` are identical to a previous
request the platform has already seen. So this harness treats the message log
